pageextension 50011 Budget_Ext extends "G/L Budget Names"
{
    layout
    {
        addbefore(Blocked)
        ...
        addafter(EditBudget)
        {
            ...
            action(Reject)
            {
                ...
                begin
                    ...
                    GLBudget.SETRANGE(GLBudget.Name, rec.Name);
                    IF GLBudget.FINDFIRST THEN BEGIN
                        GLBudget.Status := GLBudget.Status::Rejected;
                        GLBudget.Sender_ID := USERID;
                        GLBudget.Receiver_ID := SelctedUser;
                        IF GLBudget.MODIFY THEN
    ...
    var
        ...
        GLBudget, Glbudet1 : Record "G/L Budget Name";
    ...
    begin
        ...
        ApprovalEntryRec."Document No." := Rec.Name;
        ...
        ApprovalEntryRec."Record ID to Approve" := Glbudet1.RECORDID;
