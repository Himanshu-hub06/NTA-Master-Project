report 50135 "Case Type Wise SOF Status"
{
    DefaultLayout = RDLC;

    RDLCLayout = './Reports/Case Type Wise SOF Status.rdl';
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = Court, Category, "Case Type", "Case Filing Date", "Global Dimension 2 Code", "SOF Status";
            column(FileNo_WritCaseHeader; WCHRD."File No.")
            {
            }
            ...
            column(Status_WritCaseHeader; WCHRD.Status)
            {
            }
            column(Year_WritCaseHeader; WCHRD.Year)
            {
            }
            column(SectionCode_WritCaseHeader; WCHRD."Global Dimension 2 Code")
            {
            }
            column(SectionName_WritCaseHeader; WCHRD."Section Name")
            {
            }
            ...
            column(FirstHearingDate_WritCaseHeader; WCHRD."First Hearing Date")
            {
            }
            column(CaseFilingDate_WritCaseHeader; WCHRD."Case Filing Date")
            {
            }
