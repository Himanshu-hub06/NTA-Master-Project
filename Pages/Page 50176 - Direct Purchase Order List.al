page 50176 "Direct Purchase Order List"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Direct Purchase Orders';
    CardPageID = "Direct Purchase Order";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Order), "Purchase Type" = const("Direct Purchase"));
    UsageCategory = Lists;
