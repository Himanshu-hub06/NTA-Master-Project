page 50177 "Direct Purchase Order"
{
    Caption = 'Direct Purchase Order';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "Direct Purchase Order Subform")
            {
                ApplicationArea = Suite;
                Editable = Rec."Buy-from Vendor No." <> '';
    ...
    begin
        Rec."Purchase Type" := Rec."Purchase Type"::"Direct Purchase";
