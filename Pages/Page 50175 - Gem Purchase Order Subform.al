page 50175 "GeM Purchase Order Subform"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
...
#if not CLEAN17
                // field("Cross-Reference No."; "Cross-Reference No.")// nitin 07-08-2023
                // {
                //     ApplicationArea = Suite;
    ...
    var
        ItemReferenceMgt: Codeunit "Item Reference Management";
    begin
        // ItemReferenceVisible := ItemReferenceMgt.IsEnabled();//Nitin 07-08-2023
    end;
    ...
    begin
        ...
        ProposalLine.SETRANGE(ProposalLine."Purchase Type", ProposalLine."Purchase Type"::GeM);
