page 50005 "TA Bill List"
{
    ...
    //SourceTableView = where(Status = filter("CC Approved" | "RC Approved" | "Pending Approval"));
    SourceTableView = where("Bill Status" = filter(Open | "Pending For Approval" | Approved), Status = filter("RC Approved" | "CC Approved"));
    ApplicationArea = all;
