page 50173 "Gem Purchase Order List"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Gem Purchase Orders';
    CardPageID = "Gem Purchase Order";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Order), "Purchase Type" = const(GeM), "Admin Bill" = const(true));
    UsageCategory = Lists;
