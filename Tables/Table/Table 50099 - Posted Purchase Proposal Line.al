table 50099 "Posted Purchase Proposal Line"
{
    ...
    fields
    {
        ...
        field(4; Type; Option)
        {
            ...
            trigger OnValidate()
            var
                TempIndentLine: Record "Indent Line" temporary;
            begin
                // TestStatusOpen();
        ...
        {
            //TableRelation = "Product Group"; //expKC 31-01-2023
        ...
        {
            CalcFormula = Sum("Item Ledger Entry"."Remaining Quantity" WHERE("Item No." = FIELD("No."), "Global Dimension 2 Code" = CONST('04')));
            Editable = false;
    ...
    var
        ...
        DimMgt: Codeunit 408;
        PraposalHeader1: Record "Purchase Proposal Header";
        // PraposalHeader1: Record "50011";
        TempIndentLine: Record "Indent Line" temporary;
        // TempIndentLine: Record "50040" temporary;
        ...
        mitemline: Record 32;
        mremqty: Decimal;
        // mrequi1: Record "50038";
        // ReqLine: Record "50038";
        mreqno: Code[20];
        mreqlineno: Integer;
        PraposalHeader: Record "Purchase Proposal Header";
        // PraposalHeader: Record "50011";
        IndentLine: Record "Indent Line";

    procedure TestStatusOpen()
    var
    // IndentHeader: Record ;
    // IndentHeader: Record "50039";
    begin
