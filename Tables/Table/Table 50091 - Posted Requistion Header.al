table 50091 "Posted Requistion Header"
{
    ...
    fields
    {
        ...
        field(50111; "Requisition for Other Section"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(50117; "Requisition No."; Code[20])
        {
            DataClassification = ToBeClassified;
        }
    ...
    begin
        IF "No." = '' THEN BEGIN
            ...
            NoSeriesMgt.InitSeries(InvSetup."Posted Requisition No.", xRec."No. Series", 0D, "No.", "No. Series");
    ...
    begin
        ...
        IF RequistionLine.FINDFIRST THEN
            REPEAT
                NewDimSetID := DimMgt.GetDeltaDimSetID(RequistionLine."Dimension Set ID", NewParentDimSetID, OldParentDimSetID);
    ...
    begin
        UserSetup.GET(USERID);
        FILTERGROUP(2);
        IF NOT UserSetup."Allow all Location" THEN
